...
import ProjectList from '../../atom/ProjectList/ProjectList';
        ...
        <motion.div whileInView={{ opacity: 1, transform: 'none' }} variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
            ...
            >
                <div className='Box1 relative w-full h-[180px]'>
                    {/* Uncomment this if you have an image */}
                    <Img
                        src={image}
                        alt='project_image'
                    ...
                    <div className='title absolute inset-0 flex justify-end card-img_hover'>
                        ...
                        >
                            {/* Uncomment this if you have a demo image */}
                            <Img
                                src={demo}
                                alt='source code'
                        ...
                        <div
                            ...
                            className='black-gradient w-10 h-10 m-2 rounded-full flex justify-center items-center cursor-pointer'
                        >
                            {/* Uncomment this if you have a GitHub image */}
                            <Img
                                src={github}
                                alt='source code'
                                className='w-1/2 h-1/2 object-contain'
            ...
            <div className='project w-full flex'>
                ...
                >
                    <ul>
                        {list.map((item) => (
                            <ProjectList
                                key={item.id} // Ensure to add a key prop for unique identification
                                title={item.title}
